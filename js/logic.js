/* 순수 심사 판정 로직 (DOM·전역상태 비의존, 단위 테스트 대상) */
export function getAuthority(type,cost,isSelf,isJoint,natRatio){
...
export function getCentralDeadline(){
  var now=new Date();
  var y=now.getFullYear();
  var deadlines=[
...
export function buildCheckKeys(type,cost,prov,reviewType,needsTang){
